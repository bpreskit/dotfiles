;;; my-wheatgrass-theme.el --- custom theme for faces
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   ;; Highlighting faces
   `(highlight ((,class (:background "dark green"))))
   `(region ((,class (:background "dark green"))))
   `(secondary-selection ((,class (:background "dark slate gray"))))
   `(isearch ((,class (:background "dark goldenrod"))))
...
;;; my-wheatgrass-theme.el ends here
